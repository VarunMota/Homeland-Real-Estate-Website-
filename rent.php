      ...
      <div class="container">
        <div class="row justify-content-center">
          <div class="col-md-7 text-center">
            ...
            <p>Real estate agencies’ primary goal is to sell (and lease) properties. It’s a whole lot easier to get attractive properties sold and leased, and a website that highlights on beautiful spaces can make sales a cinch.</p>
          </div>
        </div>
